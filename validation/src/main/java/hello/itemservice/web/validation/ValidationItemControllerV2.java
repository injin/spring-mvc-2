...
public class ValidationItemControllerV2 {
    ...
    /**
     * (버전1) 스프링 FieldError, ObjectError 사용
     */
    //@PostMapping("/add")
    ...
    /**
     * (버전2) 사용자가 입력한 값 넘기기 : rejectedValue
     */
    //@PostMapping("/add")
    ...
    /**
     * (버전3) defaultMessage 제거 후 messageCode 사용
     */
    //@PostMapping("/add")
    ...
    /**
     * (버전4) 메시지 코드 더 간결히 사용하기 : MessageCodesResolver
     */
    //@PostMapping("/add")
    ...
    /**
     * (버전6) WebDataBinder에 검증기를 추가하여 자동 적용
     */
    @PostMapping("/add")
